...
import { makeDefineExp, makeNumExp, makeProcExp, makeVarDecl, makeVarRef, parse, unparse } from './L5-ast';
...
assert.deepEqual(L5typeof("(L5 (define (x : number) 2) (+ x 3))"), "number"); // TO DELETE